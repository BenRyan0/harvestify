...
const SearchListings = () => {
    ...
    const {allListings,listings,totalListing,latestListings, priceRange, allYieldUnits, yieldRange} = useSelector(state=>state.home)
  ...
  useEffect(() => {
    console.log("post"); // Ensure this gets logged
    dispatch(
      query_listings({
  ...
  }, [priceValues, yieldValues, category, rating, pageNumber, sortPrice, sortYield, dispatch, sortYieldUnit, searchValue]);
  ...
  return (
    <>
         ...
         <section className=' w-[85%] mx-auto h-[150px] mt-6 bg-cover bg-no-repeat relative bg-left' style={{ backgroundImage: "url('/images/banner/1.jpg')" }}>
