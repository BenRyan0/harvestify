...
const Shipping = () => {
    ...
    const applyVoucher = (listings, voucher) => {
        ...
        if (valid) {
            if (discountType === 'fixed') {
                ...
                totalPrice -= Math.floor((totalPrice * value) / 100);
            }
        }

        const totalPriceWDiscount = totalPrice - discount;
        console.log("YAWA")
        console.log(totalPriceWDiscount )
    ...
    const ConfirmDeal = () => {
        ...
        if (isStateComplete) {
            ...
            let finalPrice = applyVoucher({listings: listings[0].listingInfo,voucher});

            console.log("FINALLLLL PRICE")
            console.log(finalPrice)

            
            // const totalPriceWDiscount = listings[0].listingInfo.totalPrice - Math.floor((listings[0].listingInfo.totalPrice * listings[0].listingInfo.discount) / 100) 
