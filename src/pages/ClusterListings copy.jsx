...
import {price_range_listing,yield_range_listing,query_listings,get_listings, expected_yields_units, get_cluster_details} from '../store/reducers/homeReducer'
...
const ClusterListings = () => {
    ...
    const {categories,allListings,totalListing, priceRange, allYieldUnits, yieldRange, parPage , cluster_listings ,cluster_listings_count, seller} = useSelector(state=>state.home)
           ...
           <div className="w-full flex flex-wrap">
               ...
               <div className="w-8/12 md-lg:w-8/12 md:w-full">
                   <div className="pl-8 md:pl-0">
                           ...
                           <div className="pb-8 ">
                               <ShopListings listing={cluster_listings} styles={styles}/>
