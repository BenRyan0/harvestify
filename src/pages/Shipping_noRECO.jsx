...
const Shipping = () => {
    ...
    const checkboxHandler = (event) => {
        ...
        // Update `show` state only when "Seller Delivery" is selected
    ...
    const save =(e)=>{
        ...
        if(address && phone && additionalLocationInfo && locationInfo){
            ...
            // dispatch(place_shipping_info({myLocation,listingLocation,price}))
                                                            ...
                                                            <div className="w-full flex flex-wrap justify-between p-2">
                                                                <div className="flex justify-between sm:w-full gap-2 w-full md:flex-col flex-row ">
                                                                    ...
                                                                    <div className="w-5/12 md:w-full">
                                                                        ...
                                                                        <div className="pt-2">
                                                                            <button onClick={(e) => setValid_(false)} className='bg-red-500 px-3 py-2 font-semibold text-slate-100 rounded-md'>REMOVE VOUCHER</button>
                                                                        </div>
                                                                        </div>
