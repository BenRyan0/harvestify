       ...
       <div className="mt-3">
         ...
         <div className="w-full flex flex-row md-lg:flex-col">
           ...
           <div className="w-full relative px-2">
            ...
            <button onClick={initializeTransaction} className='bg-primaryDark px-4 py-1 rounded-sm font-bold flex justify-center items-center gap-2 hover:cursor-pointer group text-slate-100'>
