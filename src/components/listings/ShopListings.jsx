    ...
    <div className="w-full flex flex-wrap mx-auto ">
      <div
        className={`w-full grid ${
          styles === "grid"
            ? "grid-cols-2 lg:grid-cols-2 md-lg:grid-cols-2 md:grid-cols-1"
            : "grid-cols-1 md-lg:grid-cols-2 md:grid-cols-1"
        } gap-3`}
      >
          ...
          >
            <div className="relative overflow-hidden">
              <div className="flex justify-start items-end flex-col gap-1  absolute  right-2 top-2">
                {p.additionalFeatures && p.additionalFeatures.length > 0 ? (
                  p.additionalFeatures.map((feature, i) => (
                    <div
                      key={i}
                      className="text-white px-2 py-1 bg-primary/50 rounded-md font-semibold text-sm flex gap-1 items-center"
                    >
                      {feature}
                      <span>
                        <FaCircleCheck />
              ...
              <Link to={`/listing/details/${p.slug}`}>
                <img
                  className="sm:w-full w-full h-[240px] rounded-md object-cover"
                  src={p.images[0]}
                  alt="listing_image"
                />
              </Link>
            ...
            <div className="py-3 text-slate-600 px-2">
              <div className="flex justify-between">
                <h2 className="" id="listing_name">
                  <span className="font-bold bg-primaryDark rounded-sm px-2 py-[1px] text-slate-200 mr-1">
                ...
                <div className="flex gap-3 text-xl">
                  ...
                  {p.sellerDelivery && (
                    <span
                      data-tooltip-id="seller-delivery"
                      data-tooltip-content="Seller Delivery"
                    >
                      <FaTruckLoading />
                    </span>
                  )}
                  ...
                  {p.traderPickup && (
                    <span
                      data-tooltip-id="trader-pickup"
                      data-tooltip-content="Trader Pickup"
                    >
                      <FaTruck />
                    </span>
                  )}
                      ...
                      <div className="flex gap-2 justify-center items-center">
                        <div className="">
                          ...
                          <span
                            ...
                            data-tooltip-content={`Actual Yield: ${
                              p.actualHarvestYield + p.yieldUnit
                            } `}
                          >
                            {p.actualHarvestYield}
                          </span>
                  ...
                  {p.discount > 0 ? (
                    <div className="flex justify-center items-center">
                      ...
                      <h2 className="text-lg text-primaryDark pr-1">
                        {formatNumber(
                          p.totalPrice -
                            Math.floor((p.totalPrice * p.discount) / 100)
                        )}
                      </h2>
                      <p className="line-through text-slate-500">
                        {formatNumber(p.totalPrice)}
                      </p>
                      ...
                      {p.sellerId.memberCount > 1 ? (
                        <div
                          ...
                          data-tooltip-content={
                            p.sellerId.sellerType +
                            ": " +
                            p.sellerId.memberCount
                          }
                          className=""
                        >
                          <FaUsers size={20} />
              ...
              <div className="flex justify-start gap-0 py-1 items-start flex-col border-y-2 ">
                ...
                <div className="flex justify-between w-full items-center text-[15px] font-bold px-3">
                  <span className="">
                    {dateFormat(p.harvestStartDate, "mmmm dS, yyyy")}{" "}
                  </span>
                  <span>-</span>
                  <span className="">
                    {dateFormat(p.harvestEndDate, "mmmm dS, yyyy")}{" "}
                  </span>
                </div>
              </div>
