...
import { FaEye, FaHandshake, FaPhone, FaTruckLoading, FaTruck, FaCheck, FaUsers, FaUser, FaBox } from "react-icons/fa";
...
// Constants - matching FeaturedListings styling
...
const HarvestStatus = ({ listing, currentDate }) => {
  if (listing.actualHarvestYield) {
    return (
...
// Main Component
const ShopListings = ({ listings = [], styles = "grid" }) => {
  ...
  // Grid class based on styles prop
  ...
  const transformListingForCheckout = useCallback((listing) => {
    ...
    return {
      ...
      sellerDelivery: listing.sellerDelivery || true,
      traderPickup: listing.traderPickup || true,
        ...
        {listings.map((listing) => (
          ...
          >
            ...
            <div className="relative overflow-hidden">
              ...
              <HarvestStatus listing={listing} currentDate={currentDate} />
