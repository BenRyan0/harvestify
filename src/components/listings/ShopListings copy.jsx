...
const ShopListings = ({styles, listing}) => {
  return (
    <div className={`w-full grid ${styles === 'grid' ? 'grid-cols-2 lg:grid-cols-3 md-lg:grid-cols-2 md:grid-cols-1' : 'grid-cols-1 md-lg:grid-cols-2 md:grid-cols-1'} gap-3`}>
      {
       listing.map((p,i)=>
