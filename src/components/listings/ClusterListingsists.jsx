...
const ClusterListings_lists = ({listings, title,seller}) => {
  ...
  let profileImage = seller[0].profileImage
         ...
         <div key={i} className="border  group transition-all duration-500 hover:shadow-md hover:-translate-y-2 rounded-md">
            ...
            <div className="py-3 text-slate-600 px-2">
              ...
              {/* <div className="flex gap-1">
                ...
                <div className="w-full">
                  <div className="flex justify-between ">
                    <h1 className='text-sm font-semibold'>{seller.clusterName}</h1>
                    <div className="flex items-center">
...
export default ClusterListings_lists