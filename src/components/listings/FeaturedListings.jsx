...
const FeaturedListings = ({listings}) => {
  ...
  const redirect_ = (listing_) => {
    ...
    const transformedListing = {
        ...
        "sellerDelivery": listing_.sellerDelivery,
        "traderPickup": listing_.traderPickup,
        ...
        "shipPrice": listing_.shipPrice, // Assuming seller last name exists
        "pricePerUnit": listing_.pricePerUnit, // Assuming seller last name exists
        "perYield": listing_.perYield, // Assuming seller last name exists
        "listingInfo": {
            "shippingFee": listing_.shippingFee || 0
        }
    };
...
const now = new Date();
  return (
    <div className='w-[85%] flex flex-wrap mx-auto '>
      ...
      <div className="w-full grid grid-cols-3 md-lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 gap-6">
        {
         listings.map((p, i) => 
